...
CylinderC::CylinderC(float baseRadius, float topRadius, float height, int radialDivision, int heightDivision, const std::string& texturePath)
...
void CylinderC::init(float baseRadius, float topRadius, float height, int radialDivision, int heightDivision) {
...
void CylinderC::Draw(Shader& shader, const glm::mat4& transform) {
    shader.use();
    glBindVertexArray(VAO);
...
GLuint CylinderC::loadTexture(const char* path) {
    GLuint textureID;
